...
const server=spawn(process.execPath,[path.join(root,'node_modules/vinext',pkg.bin.vinext),'dev','--port',String(port)],
  {cwd:root,stdio:['ignore',log.fd,log.fd],detached:process.platform!=='win32',env:{...process.env,WRANGLER_SEND_METRICS:'false',SOURCE_COMMIT_SHA:'cef82619f109424df2f18028272b6619fad121fc',SOURCE_TREE_SHA:'9a8c2488b7da5f4e447ce930973b076671576e36',SOURCE_BUILD_ID:'cef82619f109424df2f18028272b6619fad121fc:9a8c2488b7da5f4e447ce930973b076671576e36',SOURCE_DEPLOY_ID:'staging-local-integration-20260925',DEPLOYMENT_ENVIRONMENT:'staging'}});
let spawnError;
