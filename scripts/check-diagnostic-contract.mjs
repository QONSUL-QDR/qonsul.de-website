...
assert.match(diagnosticUi,/setHasCompletedAIRun\(true\);\s+setAiSuggestions\(accepted\)/,'a successfully applied AI result marks the run complete before suggestions can be accepted or dismissed');
