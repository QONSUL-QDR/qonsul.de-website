...
export async function POST(request:Request){
  try{
    ...
    const finalStatus=crmStatus==='pending'?await syncLead({id,name,email,company,analysis,consentVersion:CONSENT_VERSION,submittedAt:now}):crmStatus;
