...
export default function QualityDiagnosticLab({ launch }: { launch?: { problem: string; id: number } }) {
  ...
  async function addAIHypotheses() {
    ...
    try {
      ...
      invalidateDraftSubmission(); setCauses(previous => [...previous, ...accepted]); setSaved(null);
      setNotice(result.notice || 'KI-Hypothesen ergänzt. Bitte mit Daten validieren; keine bestätigten Ursachen.');
